...
public class housekipping_info extends JFrame
{ JLabel sr,name,age,gender,Job,salary,mobileno,adharno,email;
    ...
    {   setBounds(100,200,1400,600);
        setVisible(true);
        setLayout(null);
        setTitle("     House Keeping Information");
        ...
        try {
            ...
            String q = "select * from addemployee where Job = 'Housekeeping'";
