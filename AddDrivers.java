...
public class AddDrivers extends JFrame implements ActionListener {
    ...
    public AddDrivers() {
        ...
        ImageIcon i1 = new ImageIcon("C:\\Users\\satya\\Desktop\\cardriver4.jpg");
        Image i2 = i1.getImage().getScaledInstance(500, 415, Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2);
        JLabel image = new JLabel(i3);
        image.setBounds(400, 0, 450, 440);
        ...
        try {
            if (e.getSource() == b1) {
                try {
                    ...
                    String yn = (String) comboBox_1.getSelectedItem();
                    String location = t5.getText();

                    PreparedStatement pst = c1.prepareStatement("insert into AddDriver (Name,Age,Gender,Car_Company,Car_Brand,Available,Location) values(?,?,?,?,?,?,?)");
